...
test-coverage: test-unit ## Run all unit tests and generate coverage report
	...
	@go tool cover -html=cover-unit.out -o coverage.html
	@echo "Coverage reports generated:"
	@echo "  - Unit tests: cover-unit.out"
...
# envtest is a dependency for running integration tests
.PHONY: envtest
...
golangci-lint: $(GOLANGCI_LINT) ## Download golangci-lint locally if necessary.
$(GOLANGCI_LINT): $(LOCALBIN)
	@echo "Downloading golangci-lint version $(GOLANGCI_LINT_VERSION)..."
	$(call go-install-tool,$(GOLANGCI_LINT),github.com/golangci/golangci-lint/v2/cmd/golangci-lint,$(GOLANGCI_LINT_VERSION))
...
# $2 - package url which can be installed (e.g., sigs.k8s.io/controller-tools/cmd/controller-gen)
# $3 - specific version of package (e.g., v0.14.0)
